...
本离线包没有原生鸿蒙应用。仍兼容 Android APK 的鸿蒙手机可以先尝试 Android `arm64-v8a` 包；HarmonyOS NEXT / HarmonyOS 5 及以上的纯鸿蒙环境不应承诺能安装 APK。若系统提示该应用无法安装或应转往应用市场，就需要寻找明确支持纯鸿蒙、并支持所需代理协议的客户端后另行核对订阅格式。Windows 与 macOS 安装包不能发给手机。
